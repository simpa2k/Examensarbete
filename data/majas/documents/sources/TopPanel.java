...
public class TopPanel extends JPanel{
	...
	private String[] categories = {"Buss", "Tunnelbana", "Tåg"};
		...
		public void valueChanged(ListSelectionEvent e){
			if(categoryList.getSelectedValue() != null){
				if (e.getValueIsAdjusting()) {
					if((categoryList.getSelectedValue()).equals("Buss")){
						ArrayList<Place> bussLista = placesByCategory.get("Buss");
						if(bussLista != null){
							checkMarked(bussLista);
						}
					}
				}
				if((categoryList.getSelectedValue()).equals("Tunnelbana")){
					ArrayList<Place> tunnelbaneLista = placesByCategory.get("Tunnelbana");
					if(tunnelbaneLista != null){
						checkMarked(tunnelbaneLista);
					}
				}
				if((categoryList.getSelectedValue()).equals("T�g")){
					ArrayList<Place> t�gLista = placesByCategory.get("T�g");
					if(t�gLista != null){
						checkMarked(t�gLista);
					}
				}
			}
		}
